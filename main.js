...
console.log("\nQuestion 50:");
let tempLiteral = `hello my name is saqlain ali shah. I am doing typescript 100 days of coding.
...
let refactor = (length1, height1) => length1 * height1;
...
console.log("\nQuestion 54:");
function flexibleObj(key, value) {
    let obje = {};
    obje[key] = value;
    return obje;
}
